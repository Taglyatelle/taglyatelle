<div align="center">
    ...
    <br/><br/>
    <p> taglyatelle automates low-value tasks on cloud platforms by combining webhooks and AI-powered slash commands. Taglyatelle can be run as Github App or locally as a standalone API.
    <br/>
    <p>
